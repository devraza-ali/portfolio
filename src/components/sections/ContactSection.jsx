      ...
      try {
        const res = await fetch("https://api.web3forms.com/submit", {
          ...
          body: JSON.stringify({
            ...
            hiring_for: type,
            from_name: "Raza Ali Malik Portfolio",
          }),
        });
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <a href="tel:+923039205909" style={{ color: C.primary, textDecoration: "none", fontSize: 15, fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 8 }}>
                  <IconForTech name="phone" size={16} colored={true} /> +92 303 920 5909
                </a>
                <a href="https://wa.me/923039205909" target="_blank" rel="noreferrer" style={{ color: "#25D366", textDecoration: "none", fontSize: 15, fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 8 }}>
