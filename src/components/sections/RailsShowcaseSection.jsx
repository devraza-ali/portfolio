...
export function RailsShowcaseSection() {
  return (
    <Section id="rails-showcase" label="Technical Depth" title="Engineering Highlights" subtitle="Not a skills checklist — concrete proof of depth across architecture, payments, integrations, and frontend delivery." tinted>
