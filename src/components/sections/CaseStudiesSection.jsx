...
export function CaseStudiesSection() {
  ...
  return (
    <Section id="case-studies" label="Selected Work" title="Featured Case Studies" subtitle="Six production SaaS builds — click the center card, or use the dots to browse." watermark="WORK">
      <FadeUp>
        <Coverflow
          items={projects}
          cardWidth={300}
