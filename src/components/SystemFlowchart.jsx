              ...
              {FLOW_CLUSTERS.map(cluster => {
                ...
                return (
                  <div
                    ...
                    style={{ padding: 8, borderRadius: C.radius, border: `1px solid ${lit ? GOLD : C.border}`, background: lit ? "rgba(143,184,255,0.04)" : C.surface, gridColumn: cluster.id === "payments" ? "1 / -1" : "auto" }}
                  >
              ...
              {FLOW_CLUSTERS.map(cluster => {
                ...
                return (
                  <path
                    ...
                    d={path}
                    fill="none"
                    stroke={active ? GOLD : "rgba(143,184,255,0.14)"}
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background: lit ? "rgba(143,184,255,0.06)" : C.surface,
      ...
      >
          ...
          return (
            <span
              style={{
                ...
                background: isAuth ? "rgba(143,184,255,0.04)" : "transparent",
                marginBottom: 12,
                width: "fit-content",
              }}
            >
        ...
        <div style={{ marginTop: "auto", borderTop: `1px dotted ${C.border}`, paddingTop: 14, display: "flex", flexDirection: "column", gap: 8 }}>
          {[
            ...
            ["Network", "centered on React + Rails"],
          ].map(([k, v]) => (
