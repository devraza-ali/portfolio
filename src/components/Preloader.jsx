...
const SKILLS = [
  "Ruby on Rails", "React", "Next.js", "PostgreSQL", "Redis",
  "AWS", "Docker", "Tailwind CSS", "TypeScript", "Stripe",
  "Actions", "Node.js", "JavaScript", "RSpec", "Jest",
];
  ...
  return (
    <div className={`preloader is-${phase}`} role="status" aria-live="polite">
      ...
      <div className="pl-caption">
        <p className="preloader-name">Raza Ali Malik</p>
